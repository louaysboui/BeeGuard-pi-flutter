...
import 'package:flutter_formation/src/constant/images.dart';
import 'package:flutter_formation/src/ui/home/home_controller.dart';
import 'package:flutter_formation/src/widget/myList.dart';
import 'package:flutter_formation/src/widget/my_chart.dart';
...
class HomeScreen extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color(0xFFEEB50B),
        elevation: 0,
        leading: IconButton(
          icon: const Icon(
            Icons.arrow_back,
